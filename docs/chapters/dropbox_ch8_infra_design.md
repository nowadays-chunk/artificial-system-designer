# Dropbox Case Study - Chapter 8: Infrastructure Implementation Oversight
...
- **Traffic Surge**: Simulates a 5x increase in upload requests to test gateway and routing scaling.
