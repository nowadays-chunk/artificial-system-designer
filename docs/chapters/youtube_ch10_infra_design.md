# YouTube Case Study - Chapter 10: Disaster Recovery and Business Continuity
...
```
         ...
         |  Video Ingest     |  < 2 minutes       |  < 1 second      |
         +-----------------------------------------------------------+
```
...
### 2.1 Video Storage Replication (Cross-Region Replication)
For transcoded video segments and binary assets, we use multi-region storage replication:
...
For transactional video metadata and directory configurations, active-active setups can cause write conflicts. We deploy an **Active-Passive replication** model:
...
export class DNSFailoverController {
  private primaryRegionHealthUrl = "https://health.us-east.youtube.com";
  private standbyRegionHealthUrl = "https://health.us-west.youtube.com";
