...
```
         ...
         |  Audio Ingestion  |  < 2 minutes       |  < 1 second      |
         +-----------------------------------------------------------+
```
...
### 2.1 Audio Object Storage Replication (Amazon S3 Cross-Region Replication)
For audio binary assets, we use Amazon S3 Cross-Region Replication (CRR):
...
export class DNSFailoverController {
  private primaryRegionHealthUrl = "https://health.us-east.spotify.com";
  private standbyRegionHealthUrl = "https://health.us-west.spotify.com";
