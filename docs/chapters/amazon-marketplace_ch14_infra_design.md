# Amazon Marketplace Case Study - Chapter 14: Lifecycle Management
...
- **Logical Replication**: Configure logical replication to copy modifications from the source database to the target database in real-time.
