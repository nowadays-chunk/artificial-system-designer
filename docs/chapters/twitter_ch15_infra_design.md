...
- **Compatibility Checks**: CI pipelines run compatibility checks on schema changes (e.g., verifying fields are not renamed or re-indexed) to prevent regressions in active services.
