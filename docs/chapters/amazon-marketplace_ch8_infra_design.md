# Amazon Marketplace Case Study - Chapter 8: Infrastructure Implementation Oversight
...
- **Cache Eviction Storms**: Evicts 50% of active keys from Redis caches to test caching fallback behaviors under load.
