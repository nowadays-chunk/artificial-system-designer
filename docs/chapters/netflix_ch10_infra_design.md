# Netflix Case Study - Chapter 10: Disaster Recovery and Business Continuity
...
For transactional user metadata and billing configurations, active-active setups can cause write conflicts. We deploy an **Active-Passive replication** model:
...
export class DNSFailoverController {
  private primaryRegionHealthUrl = "https://health.us-east.netflix.com";
  private standbyRegionHealthUrl = "https://health.us-west.netflix.com";
