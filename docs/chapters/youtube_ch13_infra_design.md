# YouTube Case Study - Chapter 13: Infrastructure Optimization
...
Because the read-to-write ratio is asymmetric (20:1), data egress cost is a primary expense. We optimize egress transit through two strategies:
